...
public final class ActivityPracticeBinding implements ViewBinding {
  ...
  private ActivityPracticeBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ConstraintLayout main, @NonNull MaterialButton numbersButton,
      @NonNull Space topSpacer) {
  ...
  public static ActivityPracticeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPracticeBinding((ConstraintLayout) rootView, challengesButton,
          lettersButton, main, numbersButton, topSpacer);
    }
