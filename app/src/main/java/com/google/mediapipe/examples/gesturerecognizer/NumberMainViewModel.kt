...
class NumberMainViewModel : ViewModel() {
    private var _delegate: Int = NumberRecognizerHelper.DELEGATE_CPU
    private var _minHandDetectionConfidence: Float =
        NumberRecognizerHelper.DEFAULT_HAND_DETECTION_CONFIDENCE
    private var _minHandTrackingConfidence: Float =
        NumberRecognizerHelper.DEFAULT_HAND_TRACKING_CONFIDENCE
    private var _minHandPresenceConfidence: Float =
        NumberRecognizerHelper.DEFAULT_HAND_PRESENCE_CONFIDENCE
